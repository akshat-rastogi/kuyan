...
def render_sidebar():
    with st.sidebar:
        ...
        if st.button("💰 Update Balances", width="stretch"):
            st.session_state.settings_nav = "Update Balances"
            st.rerun()
...
def main():
    ...
    if selected_page == "Settings":
        ...
        page_exchange_rates()
    elif selected_page == "Mortgage":
        page_mortgage()
    elif selected_page == "Update Balances":
        ...
        # Create tabs for Update Balances and Reminder
        tab1, tab2 = st.tabs(["📊 Update Balances", "🔔 Reminder"])
